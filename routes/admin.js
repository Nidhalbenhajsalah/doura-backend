...
const {getAdminProfile, createActivityAsAdmin, getAllActivities, getActivityById, editActivity,getAllActivityProviders,approveUser,rejectUser,getPendingUsers,getProviderProfile,getProviderActivities} = require('../controllers/adminControllers/adminController')
...
router.get('/provider-profile/:providerId',protect,authorizeRoles('admin'),getProviderProfile)
router.get('/provider-activities/:providerId', protect, authorizeRoles('admin'), getProviderActivities)
